    ...
    public class TokenController : ApiController
    {
        ...
        public TokenInfo Login([FromBody] LoginRequest loginRequest)
        {
            ...
            if (loginRequest != null)
            {
                ...
                //身份验证信息
                string UserIP = GetUserAgentInfo.GetIP();
                AuthInfo authInfo = new AuthInfo { UserName = userName, Roles = new List<string> { "admin", "commonrole" }, IsAdmin = isAdmin, ExpiryDateTime = DateTime.Now.AddHours(2),ReqeustIP=UserIP };
